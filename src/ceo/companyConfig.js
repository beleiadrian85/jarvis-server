...
export const COMPANY = {
  ...
  domains: {
    CASH:            { source: "declarat de Adrian (extractBalance) / formular Dana", connected: "NOT_CONNECTED", owner: "dana", impact: "Fara sold nu exista necesar NET de cash — doar necesar brut de plati.", fix: "Formular zilnic Dana (temporar) → conector bancar/SmartBill (permanent)." },
    BANK:            { source: "Banca Transilvania / BCR (fara conector)", connected: "NOT_CONNECTED", owner: "dana", impact: "Solduri si rulaje invizibile; forecastul ramane brut.", fix: "PSD2/open banking sau export zilnic; intre timp input uman." },
    ACCOUNTING:      { source: "SmartBill (integrare locala pe BIROU, neconectata la server)", connected: "PARTIAL", owner: "dana", impact: "Facturi/incasari nevizibile serverului.", fix: "Port SmartBill API pe server (exista config local .claude/smartbill-api.json)." },
    PAYABLES:        { source: "Operational: list_payment_obligations", connected: "CONNECTED", owner: "dana", impact: "-", fix: "-" },
    RECEIVABLES:     { source: "nu exista registru de incasari de primit", connected: "NOT_CONNECTED", owner: "dana", impact: "Incasarile certe/probabile lipsesc din lichiditate.", fix: "Camp in Operational sau SmartBill (facturi emise neincasate)." },
    SALES:           { source: "Operational: sales_summary + list_sales_units", connected: "CONNECTED", owner: "adrian", impact: "-", fix: "-" },
    LEADS:           { source: "nu exista CRM de lead-uri conectat", connected: "NOT_CONNECTED", owner: "adrian", impact: "Funnelul incepe abia la rezervare; conversia amonte invizibila.", fix: "Registru lead-uri in Operational sau CRM usor + conector." },
    ...
    SUPPLIERS:       { source: "Operational: comenzi materiale + preturi", connected: "PARTIAL", owner: "nelu", impact: "Risc de blocaj furnizor nevizibil.", fix: "Termene si expunere per furnizor in Operational." },
    ...
    WEBSITE_TRAFFIC: { source: "Spion Site (bellresidence.ro) — neconectat la server", connected: "NOT_CONNECTED", owner: "adrian", impact: "Trafic si conversie web invizibile motorului.", fix: "Endpoint de citire Spion + GA4 (proprietate exista: 544681576)." },
    MARKETING:       { source: "Google Ads (campanie blocata pe verificare UE), Meta", connected: "NOT_CONNECTED", owner: "adrian", impact: "Cost/lead si ROI campanii invizibile.", fix: "Conector Google Ads API dupa deblocarea verificarii." },
    EMAIL:           { source: "Gmail proficoncept.sb (OAuth configurat pe server)", connected: "CONNECTED", owner: "adrian", impact: "-", fix: "-" },
    CALENDAR:        { source: "Google Calendar (OAuth)", connected: "PARTIAL", owner: "adrian", impact: "Termene din calendar lipsesc din planificare cand tokenul expira.", fix: "Reautorizare OAuth cand pica." },
