...
export const COMPANY = {
  ...
  domains: {
    ...
    CONTRACTS:       { source: "bootstrap din obligatii recurente (chirii) + finantari", connected: "PARTIAL", owner: "adrian", impact: "Clauze/termene contractuale invizibile.", fix: "Registru contracte (Drive structurat sau Operational)." },
    ...
    ASSETS:          { source: "bootstrap din leasinguri (vehicule) — valori UNKNOWN", connected: "PARTIAL", owner: "dana", impact: "Valoarea si sarcinile activelor invizibile.", fix: "Registru active (terenuri, apartamente, utilaje)." },
  ...
  CASH: {
    ...
    request: { to: "dana", ask: "JARVIS are nevoie de soldurile actuale ale conturilor Profi Concept pentru calculul cash-flow-ului si al necesarului de lichiditate. Te rog introdu soldurile in formular pana la 09:00. Multumesc.", cadence: "zilnic 09:00" },
  },
  RECEIVABLES: {
