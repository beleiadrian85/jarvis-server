...
export const fixtures = {
  ...
  "/api/ceo/board-mode": { mode: "shadow" },

  // Ședință de Board realistă (shape identic runBoardMeeting) — DOAR demo.
  "/api/ceo/board": () => ({
    id: "bm-demo", asOf: D(0), type: "financiara",
    question: "Presiune de lichiditate în fereastra 21–35 de zile",
    problem: "Acoperim deficitul probabil din fereastra 21–35 de zile cu o linie de credit sau accelerăm colectarea avansurilor?",
    purpose: "Evită un gol de lichiditate fără a supraîndatora compania.",
    data_available: ["obligații 30z", "rezervări fără avans", "serviciul datoriei"],
    data_missing: ["soldul bancar la zi", "termene ferme pentru încasările probabile"],
    assumptions: ["Antecontractele se semnează în ritmul din ultimele 60 de zile", "Furnizorii nu cer plată în avans suplimentară"],
    options: ["Linie de credit pe termen scurt", "Campanie de colectare avansuri", "Amânarea unor plăți non-critice"],
    perspectives: [
      { role: "CFO", position: "approve_with_conditions", confidence: 72, arguments: ["O linie de credit scurtă acoperă golul fără a bloca vânzările; costul e mic vs riscul de a rata scadențe.", "Condiție: doar cu soldul bancar confirmat la zi înainte de tragere."], conditions: ["Sold bancar confirmat înainte de tragere", "Plafon maxim 300.000 lei"] },
      { role: "CRO", position: "reject", confidence: 65, arguments: ["Fără soldul real, orice tragere de credit se face pe estimări — riscul e să ne îndatorăm pentru un deficit care nu există."], risks: ["îndatorare pe date incomplete", "cost financiar recurent"] },
      { role: "COO", position: "approve", confidence: 58, arguments: ["Execuția C3 nu trebuie oprită de un gol temporar; creditul păstrează ritmul șantierului."] },
      { role: "CSO", position: "approve_with_conditions", confidence: 61, arguments: ["Colectarea avansurilor rezolvă și cash-ul, și confirmă pipeline-ul — dar durează 2–3 săptămâni."], conditions: ["Campanie de avansuri pornită în paralel"] },
      { role: "CLO", position: "insufficient_data", confidence: 40, arguments: ["Clauzele liniei de credit nu sunt pe masă; nu pot evalua garanțiile cerute."] },
      { role: "FOUNDER_VOICE", position: "approve_with_conditions", confidence: 55, arguments: ["Preferi să nu te superîndatorezi; combinația credit-mic + avansuri respectă acest principiu, dar cere soldul întâi."] },
    ],
    risks: ["Îndatorare pe date incomplete", "Cost financiar recurent dacă golul e mic", "Rezervări anulate dacă presăm avansurile prea agresiv"],
    impact: { financial: "expunere ≤300.000 lei, cost ~1–2% pe termen scurt", operational: "menține ritmul C3", human: "efort de colectare pe Dana", legal: "neevaluat — clauze lipsă", brand_sales: "risc mic de fricțiune la avansuri" },
    reversibility: "reversibila",
    scenarios: { success: "Golul acoperit, creditul rambursat din avansuri în 30 de zile", failure: "Credit tras inutil pentru un deficit care nu se materializează" },
    recommendation: {
      recommendation: "AMANA",
      consensus_level: 50,
      confidence: 44,
      data_quality: "partiala",
      major_disagreements: [
        { role: "CRO", position: "reject", reason: "Fără soldul real, orice tragere de credit se face pe estimări." },
      ],
      conditions: ["Sold bancar confirmat înainte de orice tragere", "Campanie de avansuri pornită în paralel"],
      risk_limits: ["Limitează expunerea: plafon 300.000 lei", "Limitează expunerea: cost financiar recurent"],
      stop_conditions: [],
      founder_decision_required: true,
      codex_compliance: { compliant: true, issues: [] },
      contradicts_prior: null,
    },
    blocked: null,
    missing_perspectives: [],
    founder_decision: null, outcome: null, lesson: null,
  }),
};
